                        ...
                        <AccordionContent className="flex flex-col gap-3 text-balance">
                                ...
                                <Card className="bg-neutral-100">
                                    ...
                                    <CardContent>
                                        <p className="text-brand-500">
                                            ...
                                            and sent to the client as complete
                                            HTML.
                                        </p>
                                    </CardContent>
                                </Card>
                            ...
                            <Link href="/rendering/isr" className="group">
                                <Card className="bg-neutral-100">
                                    ...
                                    <CardContent>
                                        <p className="text-brand-500">
                                            Static pages can be updated after
                                ...
                                <Card className="bg-neutral-100">
                                    ...
                                    <CardContent>
                                        <p className="text-brand-500">
                                            ...
                                            page and JavaScript renders the
                                            rest.
                                        </p>
                                    </CardContent>
                                </Card>
                        ...
                        <AccordionContent className="flex flex-col gap-3 text-balance">
                            <Link href="/streaming" className="group">
                                <Card className="bg-neutral-100">
                                    ...
                                    <CardContent>
                                        <p className="text-brand-500">
                                            Data is sent in chunks and rendered
                                            as it arrives.
                                        </p>
                                    </CardContent>
                                </Card>
                        ...
                        <AccordionContent className="flex flex-col gap-3 text-balance">
                            <Link href="/server-action" className="group">
                                <Card className="bg-neutral-100">
                                    ...
                                    <CardContent>
                                        <p className="text-brand-500">
                                            Functions that run on the server and
